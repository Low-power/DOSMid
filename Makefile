...
dosmid.exe: dosmid.c mem.c midi.c mpu401.c outdev.c timer.c ui.c xms.c
	wcl -lr -we -d0 -0 -s -ms -wx dosmid.c mem.c midi.c mpu401.c outdev.c timer.c ui.c xms.c
